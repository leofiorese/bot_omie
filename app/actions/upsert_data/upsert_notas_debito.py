...
Handles database persistence for omie.notas_debito table (PostgreSQL).
...
def upsert_data(df: pd.DataFrame, csv_path: str = None) -> int:
    """
    Bulk inserts DataFrame data into omie.notas_debito using execute_values.
